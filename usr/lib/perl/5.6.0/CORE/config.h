 ...
 */
#define ARCHLIB "/usr/lib/perl/5.6.0"		/**/
#define ARCHLIB_EXP "/usr/lib/perl/5.6.0"		/**/
 ...
 */
#define PERL_INC_VERSION_LIST "5.005",0		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "/usr/share/perl/5.6.0"		/**/
#define PRIVLIB_EXP "/usr/share/perl/5.6.0"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl/5.6.0"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl/5.6.0"		/**/
 ...
 */
#define SITELIB "/usr/local/share/perl/5.6.0"		/**/
#define SITELIB_EXP "/usr/local/share/perl/5.6.0"		/**/
#define SITELIB_STEM ""		/**/
 ...
 *	lib/lib.pm will automatically search in /usr/local/lib/perl/5.6.0 for older
 ...
 *	search in /usr/local/share/perl/5.6.0 for older directories across major versions
