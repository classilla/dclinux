...
## Package name      : perl5
## Source directory  : .
## Configuration time: Thu Mar 29 07:49:44 JST 2001
## Configured by     : root
## Target system     : linux lina2 2.4.2 #5 wed mar 28 01:22:00 jst 2001 sh4 unknown 
#
## Configure command line arguments.

my $config_sh = <<'!END!';
archlibexp='/usr/lib/perl/5.6.0'
archname='sh-linux'
cc='cc'
ccflags='-DDEBIAN -fno-strict-aliasing -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64'
cppflags='-DDEBIAN -fno-strict-aliasing -I/usr/local/include'
dlsrc='dl_dlopen.xs'
dynamic_ext='B ByteLoader DB_File Data/Dumper Devel/DProf Devel/Peek Fcntl File/Glob IO IPC/SysV Opcode POSIX SDBM_File Socket Sys/Hostname Sys/Syslog attrs re'
extensions='B ByteLoader DB_File Data/Dumper Devel/DProf Devel/Peek Fcntl File/Glob IO IPC/SysV Opcode POSIX SDBM_File Socket Sys/Hostname Sys/Syslog attrs re Errno'
installarchlib='/usr/lib/perl/5.6.0'
installprivlib='/usr/share/perl/5.6.0'
libpth='/usr/local/lib /lib /usr/lib'
libs='-lnsl -ldl -lm -lc -lcrypt'
osname='linux'
osvers='2.4.2'
prefix='/usr'
privlibexp='/usr/share/perl/5.6.0'
sharpbang='#!'
shsharp='true'
...
cccdlflags='-fPIC'
ccdlflags='-rdynamic'
ccsymbols='-Asystem=posix __GNUC_MINOR__=1 __GNUC_PATCHLEVEL__=0 __SH3__=1 __STDC_HOSTED__=1 __linux=1 __linux__=1 __sh3__=1 __sh__=1 __unix=1 __unix__=1'
cf_by='root'
cf_email='root@lina2.ta.keshi.org'
cf_time='Thu Mar 29 07:49:44 JST 2001'
charsize='1'
chgrp=''
chmod=''
chown=''
...
config_arg10='-Dsitelib=/usr/local/share/perl/5.6.0'
config_arg11='-Dsitearch=/usr/local/lib/perl/5.6.0'
config_arg12='-Dman1dir=/usr/share/man/man1'
config_arg13='-Dman3dir=/usr/share/man/man3'
config_arg14='-Dman1ext=1'
config_arg15='-Dman3ext=3perl'
config_arg16='-Dpager=/usr/bin/pager'
config_arg17='-Uafs'
config_arg18='-Ud_csh'
config_arg19='-Uusesfio'
config_arg1='-Dccflags=-DDEBIAN'
config_arg20='-Duseshrplib'
config_arg21='-Dlibperl=libperl.so.5.6.0'
config_arg22='-Dd_dosuid'
config_arg23='-des'
config_arg2='-Darchname=sh-linux'
config_arg3='-Dprefix=/usr'
config_arg4='-Dprivlib=/usr/share/perl/5.6.0'
config_arg5='-Darchlib=/usr/lib/perl/5.6.0'
config_arg6='-Dvendorprefix=/usr'
config_arg7='-Dvendorlib=/usr/share/perl5'
config_arg8='-Dvendorarch=/usr/lib/perl5'
config_arg9='-Dsiteprefix=/usr/local'
config_argc='23'
config_args='-Dccflags=-DDEBIAN -Darchname=sh-linux -Dprefix=/usr -Dprivlib=/usr/share/perl/5.6.0 -Darchlib=/usr/lib/perl/5.6.0 -Dvendorprefix=/usr -Dvendorlib=/usr/share/perl5 -Dvendorarch=/usr/lib/perl5 -Dsiteprefix=/usr/local -Dsitelib=/usr/local/share/perl/5.6.0 -Dsitearch=/usr/local/lib/perl/5.6.0 -Dman1dir=/usr/share/man/man1 -Dman3dir=/usr/share/man/man3 -Dman1ext=1 -Dman3ext=3perl -Dpager=/usr/bin/pager -Uafs -Ud_csh -Uusesfio -Duseshrplib -Dlibperl=libperl.so.5.6.0 -Dd_dosuid -des'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
cpprun='cc -E'
cppstdin='cc -E'
cppsymbols='_FILE_OFFSET_BITS=64 __GNUC_MINOR__=1 _LARGEFILE_SOURCE=1 _POSIX_C_SOURCE=199506 _POSIX_SOURCE=1 __STDC__=1 __linux=1 __linux__=1 __unix=1 __unix__=1'
crosscompile='undef'
cryptlib=''
csh='csh'
...
full_csh='csh'
full_sed='/bin/sed'
gccversion='3.1 20010308 (experimental)'
gidformat='"lu"'
gidsign='1'
gidsize='4'
gidtype='gid_t'
...
inc_version_list='5.005'
inc_version_list_init='"5.005",0'
incpath=''
inews=''
installbin='/usr/bin'
...
installsitearch='/usr/local/lib/perl/5.6.0'
installsitebin='/usr/local/bin'
installsitelib='/usr/local/share/perl/5.6.0'
...
libperl='libperl.so.5.6.0'
libsdirs=' /usr/lib'
libsfiles=' libnsl.so libdb.so libdl.so libm.so libc.so libcrypt.so'
libsfound=' /usr/lib/libnsl.so /usr/lib/libdb.so /usr/lib/libdl.so /usr/lib/libm.so /usr/lib/libc.so /usr/lib/libcrypt.so'
libspath=' /usr/local/lib /lib /usr/lib'
libswanted='sfio socket bind inet nsl nm ndbm gdbm dbm db malloc dl dld ld sun m c cposix posix ndir dir crypt sec ucb BSD PW x iconv'
line=''
lint=''
lkflags=''
ln='ln'
...
mydomain='.ta.keshi.org'
myhostname='lina2'
myuname='linux lina2 2.4.2 #5 wed mar 28 01:22:00 jst 2001 sh4 unknown '
n='-n'
...
signal_t='void'
sitearch='/usr/local/lib/perl/5.6.0'
sitearchexp='/usr/local/lib/perl/5.6.0'
sitebin='/usr/local/bin'
sitebinexp='/usr/local/bin'
sitelib='/usr/local/share/perl/5.6.0'
sitelib_stem=''
sitelibexp='/usr/local/share/perl/5.6.0'
