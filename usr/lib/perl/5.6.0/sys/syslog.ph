...
unless(defined(&_SYS_SYSLOG_H)) {
    ...
    eval 'sub LOG_PRIMASK () {0x07;}' unless defined(&LOG_PRIMASK);
    eval 'sub LOG_PRI {
        local($p) = @_;
    ...
    eval 'sub LOG_FACMASK () {0x03f8;}' unless defined(&LOG_FACMASK);
    eval 'sub LOG_FAC {
        local($p) = @_;
    ...
    eval 'sub LOG_PID () {0x01;}' unless defined(&LOG_PID);
    eval 'sub LOG_CONS () {0x02;}' unless defined(&LOG_CONS);
    eval 'sub LOG_ODELAY () {0x04;}' unless defined(&LOG_ODELAY);
    eval 'sub LOG_NDELAY () {0x08;}' unless defined(&LOG_NDELAY);
